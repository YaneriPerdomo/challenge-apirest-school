...
<head>
    ...
    <title>Challenge Api | Listado de Alumnos</title>
        ...
        <article class="flex flex-column flex-align-content-center ">
            <div class="primary-border module-width">
                <div class="flex flex-justify-content-between">
                    <div>
                        <legend><b>Listado de Alumnos</b></legend>
                        <div class="search flex flex-row ">
                            <div class="input-group  search__seeker">
                                ...
                                <input type="text" name="name" id="name"
                                    ...
                                    placeholder="Ingresa el nombre o cedula del estudiante para buscar"
                                    aria-label="Ingresa el nombre  o cedula del estudiante para buscar" autofocus
                    ...
                    <div>
                        <a href="{{ route('student.create') }}" class="text-decoration-none text-white">
                ...
                <div class="">
                    ...
                    <section class='table'>
                        <table class='dataTable'>
                            ...
                            <tbody>
                                ...
                                @else
                                    @foreach ($students->items() as $value)
                                        <tr class='show'>
                                            ...
                                            <td class='table__operations'>
                                                <a
                                                    href="{{ route($value->gender == 'M' ? 'student.subjects-male' : 'student.subjects-female', $value->slug) }}">
                                                    <button type="button" class="button yellow-button ">
                                                        <i class="bi bi-journal-text"></i>
                                                    </button>
                                                </a>
                                                <a
                                                    href="{{ route($value->gender == 'M' ? 'student.edit-male' : 'student.edit-female', $value->slug) }} ">
                                                    <button class="button green-button">
                                                        <i class="bi bi-pencil-square"></i>
                                                    </button>
                                                </a>
                                                <a
                                                    href="{{ route($value->gender == 'M' ? 'student.delete-male' : 'student.delete-female', $value->slug) }}">
                    ...
                    <div class="flex-justify-content-between">
                        <div>
                            <small>
                                Mostrando {{ $students->count() == 1 ? 'registro' : 'registros' }} 1 -
                                {{ $students->count() }}
                                de un total de {{ $students->total() }}
                            </small>
                        </div>
                        <div>
                            {{ $students->links() }}
