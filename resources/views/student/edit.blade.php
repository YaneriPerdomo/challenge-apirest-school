    ...
    <title>Challenge Api | Editar Alumno: {{ $student->name ?? '' }}</title>
    ...
    <body class="">
        ...
        <main class="main flex flex-justify-content-center">
            <article class="flex flex-column flex-align-content-center">
                <form action="{{ route('student.update', $student->slug) }}" method="POST"
                    ...
                    <legend class="form__title">
                        <b>Actualizar Datos {{ $student->gender == 'M' ? 'del Alumno' : 'de la Alumna' }}</b>
                    </legend>
                            ...
                            <div class="form__item p-0">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" id="name"
                                        ...
                                        autofocus value="{{ old('name', $student->name) }}">
                                </div>
                                @error('name')
                                    <span
                            ...
                            <div class="form__item p-0">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="lastname" id="lastname"
                                        ...
                                        placeholder="Ej: Pérez" value="{{ old('lastname', $student->lastname) }}">
                                </div>
                                @error('lastname')
                                    <span
                                        class="form__error-message text-danger text-sm mt-1 d-block"><strong>{{ $message }}</strong></span>
                            ...
                            <div class="form__item p-0">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="gender" id="gender"
                                        ...
                                        <option value="M"
                                            {{ old('gender', $student->gender) == 'M' ? 'selected' : '' }}>Masculino
                                            (M)</option>
                                        <option value="F"
                                            {{ old('gender', $student->gender) == 'F' ? 'selected' : '' }}>Femenina
                                            (F)</option>
                                    </select>
                                </div>
                                @error('gender')
                            ...
                            <div class="form__item p-0">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="identity_document" id="identity_document"
                                        ...
                                        placeholder="Dejar vacío si no posee"
                            ...
                            <div class="form__item p-0" id="wrapper-mother-document">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="mother_s_identity_document"
                                        ...
                                        value="{{ old('mother_s_identity_document', $student->mother_s_identity_document) }}">
                                </div>
