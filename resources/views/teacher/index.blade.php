...
<head>
    ...
    <title>Challenge Api | Listado de Profesores</title>
        ...
        <article class="flex flex-column  flex-align-content-center ">
            <div class="primary-border module-width">
                <div class="flex flex-justify-content-between">
                    <div>
                        <legend><b>Listado de Profesores</b></legend>
                        <div class="search flex flex-row ">
                            <div class="input-group  search__seeker">
                                ...
                                <input type="text" name="name" id="name"
                                    class="search__input  search__input--text form-control" data-url="/profesores"
                                    placeholder="Ingresa el nombre o cedula del profesor para buscar"
                                    aria-label="Ingresa el nombre o cedula del profesor para buscar" autofocus
                    ...
                    <div>
                        <a href="{{ route('teacher.create') }}" class="text-decoration-none text-white">
                ...
                <div class="">
                    ...
                    <section class='table'>
                        <table class='dataTable'>
                            ...
                            <tbody>
                                ...
                                @else
                                    @foreach ($teachers->items() as $value)
                                        <tr class='show'>
                                            ...
                                            <td class='table__operations'>
                                                ...
                                                <a
                                                    href="{{ route($value->gender == 'M' ? 'teacher.edit-male' : 'teacher.edit-female', $value->slug) }}  ">
                                                    <button class="button green-button">
                                                        <i class="bi bi-pencil-square"></i>
                                                    </button>
                                                </a>
                                                <a
                                                    href="{{ route($value->gender == 'M' ? 'teacher.delete-male' : 'teacher.delete-female', $value->slug) }}">
                    ...
                    <div class="flex-justify-content-between">
                        <div>
                            <small>
                                Mostrando {{ $teachers->count() == 1 ? 'registro' : 'registros' }} 1 -
                                {{ $teachers->count() }}
                                de un total de {{ $teachers->total() }}
                            </small>
                        </div>
                        <div>
                            {{ $teachers->links() }}
