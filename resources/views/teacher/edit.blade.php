...
<head>
    ...
    <title>Challenge Api | Editar Profesor {{ $teacher->gender == 'M' ? ' ' : 'a' }} - {{ $teacher->names }}</title>
        ...
        <article class="flex flex-column  flex-align-content-center  ">
            ...
            <form action="{{ route('teacher.update', $teacher->slug) }}" method="POST"
                ...
                <legend class="form__title">
                    <b>Editar Datos {{ $teacher->gender == 'M' ? 'del Profesor' : 'de la Profesora' }}</b>
                </legend>
                ...
                <div class="row mb-3">
                    <div class="col-6">
                        <div class="form__item p-0">
                            ...
                            <div class="input-group">
                                <span
                                    class="form__icon input-group-text @error('names') border-danger text-danger @enderror">
                                    <i class="bi bi-person"></i>
                                </span>
                                <input type="text" name="names" id="names"
                                    class="form-control @error('names') is-invalid @enderror" placeholder="Ej: Nelson"
                                    autofocus value="{{ old('names', $teacher->names) }}">
                            </div>
                            @error('names')
                                <span
                    ...
                    <div class="col-6">
                        <div class="form__item p-0">
                            ...
                            <div class="input-group">
                                <span
                                    class="form__icon input-group-text @error('lastnames') border-danger text-danger @enderror">
                                    <i class="bi bi-person-fill"></i>
                                </span>
                                <input type="text" name="lastnames" id="lastnames"
                                    class="form-control @error('lastnames') is-invalid @enderror"
                                    placeholder="Ej: Marín" value="{{ old('lastnames', $teacher->lastnames) }}">
                            </div>
                            @error('lastnames')
                                <span
                                    class="form__error-message text-danger text-sm mt-1 d-block"><strong>{{ $message }}</strong></span>
                        ...
                        <div class="form__item p-0">
                            ...
                            <div class="input-group">
                                ...
                                <select name="gender" id="gender"
                                    ...
                                    <option value="M"
                                        {{ old('gender', $teacher->gender) == 'M' ? 'selected' : '' }}>Masculino (M)
                                    </option>
                                    <option value="F"
                                        {{ old('gender', $teacher->gender) == 'F' ? 'selected' : '' }}>Femenina (F)
                                    </option>
                                </select>
                            </div>
                            @error('gender')
                ...
                <div class="form__item p-0 mb-3">
                    <label for="subject_id" class="form__label form__label--required">Asignatura a Dictar</label>
                    <div class="input-group">
                        <span
                            class="form__icon input-group-text @error('subject_id') border-danger text-danger @enderror">
                        ...
                        <select name="subject_id" id="subject_id"
                            ...
                            @foreach ($asignaturas as $asignatura)
                                <option value="{{ $asignatura->subject_id }}"
                                    {{ old('subject_id', $teacher->subject_id) == $asignatura->subject_id ? 'selected' : '' }}>
                                    {{ $asignatura->name }}
                                </option>
                            @endforeach
                        </select>
