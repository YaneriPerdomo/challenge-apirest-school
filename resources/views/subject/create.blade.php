    ...
    <title>Challenge Api | Registrar Nueva Asignatura</title>
    ...
    <body class="">
        ...
        <main class="main flex flex-justify-content-center">
            <article class="flex flex-column   flex-align-content-center   ">
                <form action="{{ route('subject.store') }}" method="POST" class="form flex flex-column primary-border module-width">
                    @csrf
                    @method('POST')

                    <legend class="form__title">
                        <b>Registrar Nueva Asignatura</b>
                    </legend>
                    ...
                    <div class="form__item mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="name" id="name"
                                ...
                                aria-label="name de la Asignatura" autofocus value="{{ old('name') }}">
                        </div>
                        @error('name')
                    ...
                    <div class="form__item mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror"
                                placeholder="Una breve descripción de la asignatura..." aria-label="Descripción de la Asignatura" rows="4">{{ old('description') }}</textarea>
                        </div>
                        @error('description')
                            <span class="form__error-message text-danger text-sm mt-1 d-block">
                                <strong>{{ $message }}</strong>
